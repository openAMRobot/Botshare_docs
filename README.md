# Botshare Docs (legacy)

This repository contains legacy documentation. Current OpenAMRobot documentation development targets [openamrobot-docs](https://github.com/openAMRobot/openamrobot-docs). Preserve this repository for migration reference; propose new documentation in the current repository.
